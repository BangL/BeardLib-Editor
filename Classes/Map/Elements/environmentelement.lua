...
function EditorEnvironment:create_element()
    ...
    self._element.values.contrast = 0.1
...
function EditorEnvironment:_build_panel()
    ...
    self:NumberCtrl("brightness", { floats = 1, help = "Sets the amount of brightness this element will apply to the level( -1 = off )" })
    self:NumberCtrl("contrast", { floats = 1, help = "Sets the amount of contrast this element will apply to the level( -1 = off )" })
    self:NumberCtrl("min_amount", { floats = 1, help = "Sets the minimum amount the random value can be" })
    self:NumberCtrl("max_amount", { floats = 1, help = "Sets the maximum amount the random value can be" })
